...
def generate_train_val_test(args):
    ...
    # Xian
    # data_seq = np.load(args.traffic_df_filename)['arr_0']
    # data_seq = data_seq.transpose(1, 0, 2)  # [num_of_vertices, num_of_timesteps, num_of_features]
    # 交通数据 (sequence_length, num_of_vertices, num_of_features)
    print(data_seq.shape)  # 数据集大小[大小，节点，维度]
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--output_dir', type=str, default="data/processed/Xian/", help="输出文件夹")
    # parser.add_argument('--traffic_df_filename', type=str, default="data/Xian/Xian.npz", help="数据集")
    parser.add_argument('--output_dir', type=str, default="data/processed/PEMS04/", help="输出文件夹")
    ...
    parser.add_argument('--seq_length_y', type=int, default=6, help='输出序列长度')
...
"""
PEMS04:
x shape:  (16978, 12, 307, 1) , y shape:  (16978, 3, 307, 1)
train x:  (10187, 12, 307, 1) y: (10187, 3, 307, 1)
val x:  (3395, 12, 307, 1) y: (3395, 3, 307, 1)
test x:  (3396, 12, 307, 1) y: (3396, 3, 307, 1)
