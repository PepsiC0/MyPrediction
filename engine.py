...
from model import ASTGCN, LSTM, GRU, GCN
from utils import utils
from torch.utils.tensorboard import SummaryWriter


class trainer():
    def __init__(self, args, scaler, input_size: int, hidden_size: int, num_layers: int, output_size: int,
                 num_of_vertices, log, lrate, device, use_mask=True, max_grad_norm=5,
                 lr_decay=False):
        """
        训练器
        :param args: 参数脚本
